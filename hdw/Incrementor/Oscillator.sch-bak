...
$EndDescr
$Comp
L Oscillator:SG-3030CM X401
U 1 1 5D786107
P 2000 3510
F 0 "X401" H 1771 3556 50  0000 R CNN
...
U 1 1 5D6C2662
P 2000 3810
F 0 "#PWR0402" H 2000 3560 50  0001 C CNN
...
AR Path="/5D784813/5D6CA24B" Ref="C401"  Part="1" 
F 0 "C401" H 1675 4690 50  0000 L CNN
F 1 "0.1uF" H 1675 4490 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 1688 4440 50  0001 C CNN
...
F 7 "311-1344-1-ND" H 2075 5090 60  0001 C CNN "Digi-Key PN"
	1    1650 4590
	1    0    0    -1  
$EndComp
$Comp
...
AR Path="/5D784813/5D6CAE3A" Ref="C402"  Part="1" 
F 0 "C402" H 2025 4690 50  0000 L CNN
F 1 "10nF" H 2025 4490 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 2038 4440 50  0001 C CNN
...
F 7 "1276-1921-1-ND" H 2425 5090 60  0001 C CNN "Digi-Key PN"
	1    2000 4590
	1    0    0    -1  
$EndComp
$Comp
...
AR Path="/5D784813/5D6CC1A6" Ref="C403"  Part="1" 
F 0 "C403" H 2375 4690 50  0000 L CNN
F 1 "1nF" H 2375 4490 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 2388 4440 50  0001 C CNN
...
F 7 "1276-1018-1-ND" H 2775 5090 60  0001 C CNN "Digi-Key PN"
	1    2350 4590
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5D6CD75A
P 2000 4820
F 0 "#PWR0404" H 2000 4570 50  0001 C CNN
...
AR Path="/5D784813/5D6EC6FD" Ref="C404"  Part="1" 
F 0 "C404" H 5085 4720 50  0000 L CNN
F 1 "0.1uF" H 5085 4520 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 5098 4470 50  0001 C CNN
...
F 7 "311-1344-1-ND" H 5485 5120 60  0001 C CNN "Digi-Key PN"
	1    5060 4620
	1    0    0    -1  
$EndComp
$Comp
...
AR Path="/5D784813/5D6EC707" Ref="C405"  Part="1" 
F 0 "C405" H 5435 4720 50  0000 L CNN
F 1 "10nF" H 5435 4520 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 5448 4470 50  0001 C CNN
...
F 7 "1276-1921-1-ND" H 5835 5120 60  0001 C CNN "Digi-Key PN"
	1    5410 4620
	1    0    0    -1  
$EndComp
$Comp
...
AR Path="/5D784813/5D6EC711" Ref="C406"  Part="1" 
F 0 "C406" H 5785 4720 50  0000 L CNN
F 1 "1nF" H 5785 4520 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 5798 4470 50  0001 C CNN
...
F 7 "1276-1018-1-ND" H 6185 5120 60  0001 C CNN "Digi-Key PN"
	1    5760 4620
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5D6EC724
P 5410 4850
F 0 "#PWR0410" H 5410 4600 50  0001 C CNN
...
AR Path="/5D784813/5D6DB85E" Ref="R402"  Part="1" 
F 0 "R402" H 4630 4000 50  0000 L CNN
...
AR Path="/5D784813/5D6DB853" Ref="#PWR0406"  Part="1" 
F 0 "#PWR0406" H 4530 3740 50  0001 C CNN
...
AR Path="/5D784813/5D6CFEE6" Ref="R401"  Part="1" 
F 0 "R401" H 3970 4000 50  0000 L CNN
...
AR Path="/5D784813/5D6CFEEC" Ref="#PWR0405"  Part="1" 
F 0 "#PWR0405" H 3870 3740 50  0001 C CNN
...
U 1 1 5D6D3FF5
P 5410 3910
F 0 "#PWR0408" H 5410 3660 50  0001 C CNN
...
$EndComp
$Comp
L 74xx:74HC4024 U401
U 1 1 5D6C3D8A
P 5410 3410
F 0 "U401" H 5160 3860 50  0000 C CNN
...
U 1 1 5D708DCC
P 8860 4560
F 0 "#PWR0414" H 8860 4310 50  0001 C CNN
...
AR Path="/5D784813/5D70B503" Ref="R404"  Part="1" 
F 0 "R404" H 7980 3950 50  0000 L CNN
...
AR Path="/5D784813/5D70B509" Ref="#PWR0412"  Part="1" 
F 0 "#PWR0412" H 7880 3690 50  0001 C CNN
...
AR Path="/5D784813/5D70B513" Ref="R403"  Part="1" 
F 0 "R403" H 7320 3950 50  0000 L CNN
...
AR Path="/5D784813/5D70B51A" Ref="#PWR0411"  Part="1" 
F 0 "#PWR0411" H 7220 3690 50  0001 C CNN
...
AR Path="/5D784813/5D714235" Ref="C407"  Part="1" 
F 0 "C407" H 8535 5360 50  0000 L CNN
F 1 "0.1uF" H 8535 5160 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 8548 5110 50  0001 C CNN
...
F 7 "311-1344-1-ND" H 8935 5760 60  0001 C CNN "Digi-Key PN"
	1    8510 5260
	1    0    0    -1  
$EndComp
$Comp
...
AR Path="/5D784813/5D71423F" Ref="C408"  Part="1" 
F 0 "C408" H 8885 5360 50  0000 L CNN
F 1 "10nF" H 8885 5160 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 8898 5110 50  0001 C CNN
...
F 7 "1276-1921-1-ND" H 9285 5760 60  0001 C CNN "Digi-Key PN"
	1    8860 5260
	1    0    0    -1  
$EndComp
$Comp
...
AR Path="/5D784813/5D714249" Ref="C409"  Part="1" 
F 0 "C409" H 9235 5360 50  0000 L CNN
F 1 "1nF" H 9235 5160 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 9248 5110 50  0001 C CNN
...
F 7 "1276-1018-1-ND" H 9635 5760 60  0001 C CNN "Digi-Key PN"
	1    9210 5260
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5D71425C
P 8860 5490
F 0 "#PWR0416" H 8860 5240 50  0001 C CNN
