...
AR Path="/5D6C0D3B/5D75BB76" Ref="U41"  Part="1" 
F 0 "U41" H 5560 3055 50  0000 C CNN
...
AR Path="/5D6C0D3B/5D75BB7C" Ref="#PWR0228"  Part="1" 
F 0 "#PWR0228" H 4680 2560 50  0001 C CNN
...
AR Path="/5D6C0D3B/5D75BB84" Ref="#PWR0229"  Part="1" 
F 0 "#PWR0229" H 4680 4170 50  0001 C CNN
...
AR Path="/5D6C0D3B/5D75BB8E" Ref="RN8"  Part="1" 
F 0 "RN8" V 6793 3190 50  0000 C CNN
...
AR Path="/5D6C0D3B/5D75BB9C" Ref="U42"  Part="1" 
F 0 "U42" H 8450 3857 50  0000 C CNN
...
AR Path="/5D6C0D3B/5D75BBAA" Ref="#PWR0232"  Part="1" 
F 0 "#PWR0232" H 8830 3420 50  0001 C CNN
...
U 1 1 5D75BBB9
P 4110 4410
AR Path="/5D6B2673/5D75BBB9" Ref="R?"  Part="1" 
AR Path="/5D6C0D3B/5D75BBB9" Ref="R80"  Part="1" 
F 0 "R80" H 4210 4570 50  0000 L CNN
...
U 1 1 5D75BBC3
P 3540 4410
AR Path="/5D6B2673/5D75BBC3" Ref="R?"  Part="1" 
AR Path="/5D6C0D3B/5D75BBC3" Ref="R79"  Part="1" 
F 0 "R79" H 3640 4570 50  0000 L CNN
...
AR Path="/5D6C0D3B/5D75BBCD" Ref="R78"  Part="1" 
F 0 "R78" H 3100 4570 50  0000 L CNN
...
U 1 1 5D75BBD3
P 4110 4560
AR Path="/5D6B2673/5D75BBD3" Ref="#PWR?"  Part="1" 
AR Path="/5D6C0D3B/5D75BBD3" Ref="#PWR0227"  Part="1" 
F 0 "#PWR0227" H 4110 4310 50  0001 C CNN
...
U 1 1 5D75BBD9
P 3540 4560
AR Path="/5D6B2673/5D75BBD9" Ref="#PWR?"  Part="1" 
AR Path="/5D6C0D3B/5D75BBD9" Ref="#PWR0226"  Part="1" 
F 0 "#PWR0226" H 3540 4310 50  0001 C CNN
...
AR Path="/5D6C0D3B/5D75BBDF" Ref="#PWR0225"  Part="1" 
F 0 "#PWR0225" H 3000 4310 50  0001 C CNN
...
AR Path="/5D6C0D3B/5D75BBFB" Ref="C59"  Part="1" 
F 0 "C59" H 5695 5180 50  0000 L CNN
...
AR Path="/5D6C0D3B/5D75BC01" Ref="#PWR0231"  Part="1" 
F 0 "#PWR0231" H 5670 4980 50  0001 C CNN
...
AR Path="/5D6C0D3B/5D75BC07" Ref="#PWR0230"  Part="1" 
F 0 "#PWR0230" H 5670 4780 50  0001 C CNN
