...
U 1 1 5D747076
P 3590 3400
F 0 "J2" H 3590 3500 50  0000 C CNN
F 1 "CLK_IN" H 3590 3200 50  0000 C CNN
F 2 "" H 3590 3400 50  0001 C CNN
...
U 1 1 5D74741D
P 3870 3580
F 0 "#PWR0161" H 3870 3330 50  0001 C CNN
...
Wire Wire Line
	3870 3500 3790 3500
$Comp
L Custom_Library:R_Custom R54
U 1 1 5D7487B1
P 4760 3400
F 0 "R54" V 4660 3400 50  0000 C CNN
F 1 "100" V 4760 3400 50  0000 C CNN
F 2 "" H 4760 3400 50  0001 C CNN
...
F 7 "PN" H 5060 3800 60  0001 C CNN "Digi-Key PN"
	1    4760 3400
	0    -1   -1   0   
$EndComp
$Comp
...
AR Path="/5D73A07C/5D74A5D7" Ref="R55"  Part="1" 
F 0 "R55" H 5420 3300 50  0000 L CNN
F 1 "10k" V 5320 3070 50  0000 L CNN
F 2 "" H 5320 3140 50  0001 C CNN
...
F 7 "PN" H 5620 3540 60  0001 C CNN "Digi-Key PN"
	1    5320 3140
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	5320 3400 4910 3400
$Comp
L Custom_Library:+3.3V #PWR0163
U 1 1 5D74A7A6
P 5320 2990
F 0 "#PWR0163" H 5320 2840 50  0001 C CNN
...
U 1 1 5D74D4DA
P 5320 3740
F 0 "D11" V 5240 3820 50  0000 L CNN
...
U 1 1 5D74D994
P 5320 3890
F 0 "#PWR0164" H 5320 3640 50  0001 C CNN
...
$Comp
L Custom_Library:74LVC1G17_Power U26
U 1 1 5D74F325
P 6550 3400
F 0 "U26" H 6650 3550 50  0000 L CNN
...
$EndComp
$Comp
L Custom_Library:R_Custom R56
U 1 1 5D74FE26
P 5970 3400
F 0 "R56" V 5870 3400 50  0000 C CNN
F 1 "100" V 5970 3400 50  0000 C CNN
F 2 "" H 5970 3400 50  0001 C CNN
...
F 7 "PN" H 6270 3800 60  0001 C CNN "Digi-Key PN"
	1    5970 3400
	0    -1   -1   0   
$EndComp
Wire Wire Line
...
U 1 1 5D7506EC
P 6550 3500
F 0 "#PWR0166" H 6550 3250 50  0001 C CNN
...
$EndComp
$Comp
L Custom_Library:+3.3V #PWR0165
U 1 1 5D750A87
P 6550 3300
F 0 "#PWR0165" H 6550 3150 50  0001 C CNN
...
AR Path="/5D73A07C/5D752E12" Ref="C51"  Part="1" 
F 0 "C51" H 6735 4190 50  0000 L CNN
F 1 "0.1uF" H 6735 3990 50  0000 L CNN
F 2 "" H 6748 3940 50  0001 C CNN
...
F 7 "PN" H 7135 4590 60  0001 C CNN "Digi-Key PN"
	1    6710 4090
	1    0    0    -1  
$EndComp
$Comp
...
AR Path="/5D73A07C/5D752E18" Ref="#PWR0168"  Part="1" 
F 0 "#PWR0168" H 6710 3990 50  0001 C CNN
...
AR Path="/5D73A07C/5D752E1E" Ref="#PWR0167"  Part="1" 
F 0 "#PWR0167" H 6710 3790 50  0001 C CNN
...
U 1 1 5D756832
P 3590 4100
F 0 "J3" H 3590 4200 50  0000 C CNN
F 1 "CLK_IN" H 3590 3900 50  0000 C CNN
F 2 "" H 3590 4100 50  0001 C CNN
...
U 1 1 5D757976
P 3870 4280
F 0 "#PWR0162" H 3870 4030 50  0001 C CNN
