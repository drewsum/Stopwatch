...
U 1 1 5D786107
P 2000 3510
F 0 "X1" H 1771 3556 50  0000 R CNN
...
U 1 1 5D6C2662
P 2000 3810
F 0 "#PWR025" H 2000 3560 50  0001 C CNN
...
$EndComp
$Comp
L Custom_Library:+3.3V #PWR024
U 1 1 5D6C28EF
P 2000 3130
F 0 "#PWR024" H 2000 2980 50  0001 C CNN
...
AR Path="/5D784813/5D6CA24B" Ref="C12"  Part="1" 
F 0 "C12" H 1675 4690 50  0000 L CNN
...
AR Path="/5D784813/5D6CAE3A" Ref="C13"  Part="1" 
F 0 "C13" H 2025 4690 50  0000 L CNN
...
AR Path="/5D784813/5D6CC1A6" Ref="C14"  Part="1" 
F 0 "C14" H 2375 4690 50  0000 L CNN
...
$EndComp
$Comp
L Custom_Library:+3.3V #PWR026
U 1 1 5D6CCD89
P 2000 4360
F 0 "#PWR026" H 2000 4210 50  0001 C CNN
...
U 1 1 5D6CD75A
P 2000 4820
F 0 "#PWR027" H 2000 4570 50  0001 C CNN
...
AR Path="/5D784813/5D6EC6FD" Ref="C15"  Part="1" 
F 0 "C15" H 5085 4720 50  0000 L CNN
...
AR Path="/5D784813/5D6EC707" Ref="C16"  Part="1" 
F 0 "C16" H 5435 4720 50  0000 L CNN
...
AR Path="/5D784813/5D6EC711" Ref="C17"  Part="1" 
F 0 "C17" H 5785 4720 50  0000 L CNN
...
$EndComp
$Comp
L Custom_Library:+3.3V #PWR032
U 1 1 5D6EC717
P 5410 4390
F 0 "#PWR032" H 5410 4240 50  0001 C CNN
...
U 1 1 5D6EC724
P 5410 4850
F 0 "#PWR033" H 5410 4600 50  0001 C CNN
...
AR Path="/5D784813/5D6DB85E" Ref="R15"  Part="1" 
F 0 "R15" H 4630 4000 50  0000 L CNN
...
AR Path="/5D784813/5D6DB853" Ref="#PWR029"  Part="1" 
F 0 "#PWR029" H 4530 3740 50  0001 C CNN
...
AR Path="/5D784813/5D6CFEE6" Ref="R14"  Part="1" 
F 0 "R14" H 3970 4000 50  0000 L CNN
...
AR Path="/5D784813/5D6CFEEC" Ref="#PWR028"  Part="1" 
F 0 "#PWR028" H 3870 3740 50  0001 C CNN
...
U 1 1 5D6D3FF5
P 5410 3910
F 0 "#PWR031" H 5410 3660 50  0001 C CNN
...
$EndComp
$Comp
L Custom_Library:+3.3V #PWR030
U 1 1 5D6D3B37
P 5410 2910
F 0 "#PWR030" H 5410 2760 50  0001 C CNN
...
U 1 1 5D6C3D8A
P 5410 3410
F 0 "U3" H 5160 3860 50  0000 C CNN
...
U 1 1 5D7081F1
P 8860 3660
F 0 "U4" H 8560 4310 50  0000 C CNN
...
U 1 1 5D708DCC
P 8860 4560
F 0 "#PWR037" H 8860 4310 50  0001 C CNN
...
$EndComp
$Comp
L Custom_Library:+3.3V #PWR036
U 1 1 5D7092A9
P 8860 2860
F 0 "#PWR036" H 8860 2710 50  0001 C CNN
...
AR Path="/5D784813/5D70B503" Ref="R17"  Part="1" 
F 0 "R17" H 7980 3950 50  0000 L CNN
...
AR Path="/5D784813/5D70B509" Ref="#PWR035"  Part="1" 
F 0 "#PWR035" H 7880 3690 50  0001 C CNN
...
AR Path="/5D784813/5D70B513" Ref="R16"  Part="1" 
F 0 "R16" H 7320 3950 50  0000 L CNN
...
AR Path="/5D784813/5D70B51A" Ref="#PWR034"  Part="1" 
F 0 "#PWR034" H 7220 3690 50  0001 C CNN
...
AR Path="/5D784813/5D714235" Ref="C18"  Part="1" 
F 0 "C18" H 8535 5360 50  0000 L CNN
...
AR Path="/5D784813/5D71423F" Ref="C19"  Part="1" 
F 0 "C19" H 8885 5360 50  0000 L CNN
...
AR Path="/5D784813/5D714249" Ref="C20"  Part="1" 
F 0 "C20" H 9235 5360 50  0000 L CNN
...
$EndComp
$Comp
L Custom_Library:+3.3V #PWR038
U 1 1 5D71424F
P 8860 5030
F 0 "#PWR038" H 8860 4880 50  0001 C CNN
...
U 1 1 5D71425C
P 8860 5490
F 0 "#PWR039" H 8860 5240 50  0001 C CNN
