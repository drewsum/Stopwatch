...
AR Path="/5D6C0D17/5D704A40" Ref="U29"  Part="1" 
F 0 "U29" H 5560 3055 50  0000 C CNN
...
AR Path="/5D6C0D17/5D704A46" Ref="#PWR0180"  Part="1" 
F 0 "#PWR0180" H 4680 2560 50  0001 C CNN
...
AR Path="/5D6C0D17/5D704A4E" Ref="#PWR0181"  Part="1" 
F 0 "#PWR0181" H 4680 4170 50  0001 C CNN
...
AR Path="/5D6C0D17/5D704A58" Ref="RN2"  Part="1" 
F 0 "RN2" V 6793 3190 50  0000 C CNN
...
AR Path="/5D6C0D17/5D704A66" Ref="U30"  Part="1" 
F 0 "U30" H 8450 3857 50  0000 C CNN
...
AR Path="/5D6C0D17/5D704A74" Ref="#PWR0184"  Part="1" 
F 0 "#PWR0184" H 8830 3420 50  0001 C CNN
...
U 1 1 5D704A83
P 4110 4410
AR Path="/5D6B2673/5D704A83" Ref="R?"  Part="1" 
AR Path="/5D6C0D17/5D704A83" Ref="R62"  Part="1" 
F 0 "R62" H 4210 4570 50  0000 L CNN
...
U 1 1 5D704A8D
P 3540 4410
AR Path="/5D6B2673/5D704A8D" Ref="R?"  Part="1" 
AR Path="/5D6C0D17/5D704A8D" Ref="R61"  Part="1" 
F 0 "R61" H 3640 4570 50  0000 L CNN
...
AR Path="/5D6C0D17/5D704A97" Ref="R60"  Part="1" 
F 0 "R60" H 3100 4570 50  0000 L CNN
...
U 1 1 5D704A9D
P 4110 4560
AR Path="/5D6B2673/5D704A9D" Ref="#PWR?"  Part="1" 
AR Path="/5D6C0D17/5D704A9D" Ref="#PWR0179"  Part="1" 
F 0 "#PWR0179" H 4110 4310 50  0001 C CNN
...
U 1 1 5D704AA3
P 3540 4560
AR Path="/5D6B2673/5D704AA3" Ref="#PWR?"  Part="1" 
AR Path="/5D6C0D17/5D704AA3" Ref="#PWR0178"  Part="1" 
F 0 "#PWR0178" H 3540 4310 50  0001 C CNN
...
AR Path="/5D6C0D17/5D704AA9" Ref="#PWR0177"  Part="1" 
F 0 "#PWR0177" H 3000 4310 50  0001 C CNN
...
AR Path="/5D6C0D17/5D704AC5" Ref="C53"  Part="1" 
F 0 "C53" H 5695 5180 50  0000 L CNN
...
AR Path="/5D6C0D17/5D704ACB" Ref="#PWR0183"  Part="1" 
F 0 "#PWR0183" H 5670 4980 50  0001 C CNN
...
AR Path="/5D6C0D17/5D704AD1" Ref="#PWR0182"  Part="1" 
F 0 "#PWR0182" H 5670 4780 50  0001 C CNN
